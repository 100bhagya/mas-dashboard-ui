  ...
  return (
    <div className="basis-3/5">
      <div className="md:p-10 p-6">
        ...
        ></div>
        <div className="text-xl text-sky-800 mt-5">Latest test Performance</div>

        <div
          id="performanceCard"
          className="grid grid-cols-5 gap-4 md:p-10 p-6 shadow-xl"
        >
          <div>
            <div className="md:text-2xl  text-xl border-b-2 w-fit pb-2 border-gray-500">
              Tech
            </div>
            <div className="md:text-2xl text-lg text-sky-800 mt-4">#18</div>
        ...
        <div>
          <div className="text-xl text-sky-800 my-10">Performance History</div>
        ...
        <div>
          <div className="text-xl text-sky-800 my-10">Course completion</div>
