      ...
      <div className="flex-grow py-10 md:px-20 px-10">
        ...
        <div className="mt-2 flex gap-8 pt-10 lg:flex-row md:flex-col">
          <p className="pr-8 basis-1/2 ">
            ...
            handling techniques and problem-solving skills of an individual. It
            is an important requisite in clearing the preliminary stages of
            several exams, especially the Management courses. The whole purpose
            of Quantitative Aptitude is to evaluate the thinking process along
            with the analytical skills of the aspirants. It is not just the
            ability to solve numerical problems, the candidates require a lot of
            logical thinking to crack Quantitative Aptitude
          </p>
