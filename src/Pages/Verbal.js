    ...
    <div className="flex-grow py-10 md:px-20 px-10">
      ...
      <div className="mt-2 flex gap-8 pt-10 lg:flex-row md:flex-col">
        <p className="pr-8 basis-1/2 ">
          Verbal aptitude refers to a person's ability to understand and respond
          to spoken information. Aptitude tests are used to assess an
          individual's skills or ability. These tests are intended to evaluate
          the person's natural abilities or talents rather than learned skills.
          To prepare for Verbal, stick to the rule of – concepts first and
          practice later. Study English grammar to understand the concepts. Then
          practice a number of sample questions of different kinds to gain
          confidence, speed and accuracy. Develop the habit of reading from
          early stages.
        </p>
